export const labelClass = `block text-gray-700 text-sm font-bold mb-2`;
...
export const thClasses = `px-1 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider`;
export const tdClasses = `px-1 py-2 border-b border-gray-200 bg-white text-sm`;
export const pClasses = `text-gray-900 whitespace-no-wrap`;
